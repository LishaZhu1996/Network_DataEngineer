...
Steps:
  ...
  3. Write silver.network_metrics_clean as an Iceberg table.

DQ checks are handled by the dedicated run_dq_checks DAG task before this runs.
"""
import json
import logging
import os
